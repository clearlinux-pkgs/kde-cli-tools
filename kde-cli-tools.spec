...
Source0  : https://download.kde.org/stable/plasma/5.14.3/kde-cli-tools-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/kde-cli-tools-5.14.3.tar.xz.sig
...
%prep
%setup -q -n kde-cli-tools-5.14.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541539776
mkdir -p clr-build
pushd clr-build
%cmake ..
