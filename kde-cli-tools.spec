...
Version  : 6.3.2
Release  : 113
URL      : https://download.kde.org/stable/plasma/6.3.2/kde-cli-tools-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/kde-cli-tools-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/kde-cli-tools-6.3.2.tar.xz.sig
...
%setup -q -n kde-cli-tools-6.3.2
cd %{_builddir}/kde-cli-tools-6.3.2
pushd ..
cp -a kde-cli-tools-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741117808
mkdir -p clr-build
pushd clr-build
...
%files locales -f kcm_filetypes.lang -f kdesu.lang -f kstart.lang -f kbroadcastnotification.lang -f kde-inhibit.lang -f kioclient.lang -f kmimetypefinder.lang -f plasma-open-settings.lang
%defattr(-,root,root,-)
