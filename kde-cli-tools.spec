...
Source0  : https://download.kde.org/stable/plasma/6.3.4/kde-cli-tools-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/kde-cli-tools-6.3.4.tar.xz.sig
...
%setup -q -n kde-cli-tools-6.3.4
cd %{_builddir}/kde-cli-tools-6.3.4
pushd ..
cp -a kde-cli-tools-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744144100
mkdir -p clr-build
pushd clr-build
