...
Version  : 5.27.7
Release  : 86
URL      : https://download.kde.org/stable/plasma/5.27.7/kde-cli-tools-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/kde-cli-tools-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/kde-cli-tools-5.27.7.tar.xz.sig
...
%prep
%setup -q -n kde-cli-tools-5.27.7
cd %{_builddir}/kde-cli-tools-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690902363
mkdir -p clr-build
pushd clr-build
