...
Version  : 5.26.1
Release  : 72
URL      : https://download.kde.org/stable/plasma/5.26.1/kde-cli-tools-5.26.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.1/kde-cli-tools-5.26.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.1/kde-cli-tools-5.26.1.tar.xz.sig
...
%prep
%setup -q -n kde-cli-tools-5.26.1
cd %{_builddir}/kde-cli-tools-5.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666289077
mkdir -p clr-build
pushd clr-build
