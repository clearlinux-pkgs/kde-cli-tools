...
Version  : 5.23.0
Release  : 53
URL      : https://download.kde.org/stable/plasma/5.23.0/kde-cli-tools-5.23.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.0/kde-cli-tools-5.23.0.tar.xz
...
%prep
%setup -q -n kde-cli-tools-5.23.0
cd %{_builddir}/kde-cli-tools-5.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634575858
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/Artistic-2.0.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/3ec1fc444ebaad19281d7bb54b57ade79f150d8c
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kde-cli-tools-5.23.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kde-cli-tools/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kde-cli-tools-5.23.0/kdesu/LICENSE.readme %{buildroot}/usr/share/package-licenses/kde-cli-tools/2252f91fd990d9bad4fc93c8810bfa5df0f4e4cb
pushd clr-build
%make_install
popd
