...
Source0  : https://download.kde.org/stable/plasma/5.18.1/kde-cli-tools-5.18.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.1/kde-cli-tools-5.18.1.tar.xz.sig
...
%prep
%setup -q -n kde-cli-tools-5.18.1
cd %{_builddir}/kde-cli-tools-5.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582089962
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-cli-tools-5.18.1/COPYING %{buildroot}/usr/share/package-licenses/kde-cli-tools/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kde-cli-tools-5.18.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kde-cli-tools/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/kde-cli-tools-5.18.1/kdesu/LICENSE.readme %{buildroot}/usr/share/package-licenses/kde-cli-tools/2252f91fd990d9bad4fc93c8810bfa5df0f4e4cb
pushd clr-build
%make_install
popd
