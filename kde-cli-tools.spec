...
Source0  : https://download.kde.org/stable/plasma/5.16.3/kde-cli-tools-5.16.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.3/kde-cli-tools-5.16.3.tar.xz.sig
...
%prep
%setup -q -n kde-cli-tools-5.16.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562813385
mkdir -p clr-build
pushd clr-build
